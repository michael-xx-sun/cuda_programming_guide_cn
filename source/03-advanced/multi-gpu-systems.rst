...
.. _sec:multi-gpu-context-execution:
...
.. _sec:multi-gpu-device-enumeration:
...
.. _sec:multi-gpu-device-selection:
...
.. _sec:multi-gpu-stream-and-event-behavior:
...
.. _sec:multi-gpu-peer-memory-access:

多设备点对点传输和内存访问
--------------------------

.. _sec:multi-gpu-peer-to-peer-transfers:
...
.. _sec:multi-gpu-peer-to-peer-memory-access:
...
.. _sec:multi-gpu-peer-to-peer-memory-consistency-synchronization:
...
.. _sec:multi-gpu-host-iommu-acs-vm:
