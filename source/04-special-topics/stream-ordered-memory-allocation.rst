.. _sec:stream-ordered-memory-allocation-details:

4.3. 流有序内存分配器
======================

.. _sec:soma-introduction:
...
.. _sec:soma-default-implicit-pools:
...
.. _sec:soma-device-accessibility:
...
.. _sec:soma-enabling-memory-pools-for-ipc:
...
.. _sec:soma-creating-sharing-ipc-pools:
...
.. _sec:soma-set-access-importing-process:
...
.. _sec:soma-creating-sharing-allocations:
...
.. _sec:soma-ipc-export-pool-limitations:
...
.. _sec:soma-ipc-import-pool-limitations:
...
.. _sec:soma-best-practices:

4.3.4. 最佳实践和调优
----------------------

.. _sec:soma-query-support:
...
.. _sec:soma-physical-page-caching:
...
.. _sec:soma-resource-usage-statistics:
...
.. _sec:soma-memory-reuse-policies:
...
.. _sec:soma-cudaMemPoolReuseFollowEventDependencies:
...
.. _sec:soma-cudaMemPoolReuseAllowOpportunistic:
...
.. _sec:soma-cudaMemPoolReuseAllowInternalDependencies:
...
.. _sec:soma-disabling-reuse-policies:
...
.. _sec:soma-synchronization-api-actions:
...
.. _sec:soma-cudaMemcpyAsync-sensitivity:
...
.. _sec:soma-cudaPointerGetAttributes:
...
.. _sec:soma-cudaGraphAddMemsetNode:
