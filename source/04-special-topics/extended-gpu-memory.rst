.. _sec:extended-gpu-memory-details:
...
.. _sec:using-egm-interface:

使用 EGM 接口
-------------

.. _sec:egm-single-node-single-gpu:
...
.. _sec:egm-single-node-multi-gpu:
