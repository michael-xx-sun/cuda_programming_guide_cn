...
.. _sec:compute-capability-and-streaming-multiprocessor-versions:
...
.. _sec:cuda-toolkit-and-nvidia-driver:
...
.. _sec:cuda-runtime-api-and-cuda-driver-api:
...
.. _sec:parallel-thread-execution-ptx:
